...
# cleos -u https://api-kylin.eosasia.one push action eosio.token transfer '[ "minakokojima", "eosotcbackup", "1.0000 EOS", "ask,0.4999 HPY,happyeosslot" ]' -p minakokojima@active

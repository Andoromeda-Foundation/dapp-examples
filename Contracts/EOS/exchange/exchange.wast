(module
 ...
 (table 4 4 anyfunc)
 (elem (i32.const 0) $__wasm_nullptr $_ZN6pomelo11cancell_allEy $_ZN6pomelo4sellEyN5eosio5assetEy $_ZN6pomelo3buyEyN5eosio5assetEy)
 (memory $0 1)
   ...
   (block $label$46
    (block $label$47
     (block $label$48
      ...
      (drop
       (call $_ZN5eosio14execute_actionI6pomeloS1_JyEEEbPT_MT0_FvDpT1_E
        (i32.add
         (get_local $11)
         (i32.const 48)
        )
 ...
 (func $_ZN6pomelo11cancell_allEy (type $FUNCSIG$vij) (param $0 i32) (param $1 i64)
 )
 (func $_ZN5eosio14execute_actionI6pomeloS1_JyEEEbPT_MT0_FvDpT1_E (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i64)
  (local $4 i32)
  (local $5 i32)

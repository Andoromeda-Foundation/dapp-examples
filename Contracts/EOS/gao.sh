...
cleos -u https://api-kylin.eosasia.one push action eosio.token transfer '[ "minakokojima", "happyeosslot", "1000.0000 EOS", "buy" ]' -p minakokojima@active
...
cleos -u https://api-kylin.eosasia.one push action happyeosslot sell '["minakokojima", "8541.0196 HPY"]' -p minakokojima@active

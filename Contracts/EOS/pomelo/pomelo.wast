(module
 ...
 (data (i32.const 608) "Must sale non-EOS currency\00")
 (data (i32.const 656) "write\00")
 (data (i32.const 672) "invalid token transfer\00")
 (data (i32.const 704) "must bet a positive amount\00")
 (data (i32.const 736) "buy\00")
 (data (i32.const 752) "only EOS allowed\00")
 (data (i32.const 784) "onerror\00")
 (data (i32.const 800) "eosio\00")
 (data (i32.const 816) "onerror action\'s are only valid from the \"eosio\" system account\00")
 (data (i32.const 880) "onTransfer\00")

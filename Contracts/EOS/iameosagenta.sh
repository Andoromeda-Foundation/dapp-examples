...
cleos -u https://mainnet.genereos.io:443 push action eosio.token dd '["1"]' -p iameosagenta@active
cleos -u https://mainnet.genereos.io:443 push action eosio.token transfer '["iameosagenta", "youhappyisok", "0.0001 EOS", "0 1781fb6e332ba3a9e575ac5f210ed9d6b30f3ff2183a20ab04804e9a796e3414"]' -p iameosagenta@active


# /usr/local/eosio/bin/eosiocpp -g iameosagenta/iameosagenta.abi iameosagenta/iameosagenta.cpp

/usr/local/eosio/bin/eosiocpp -o iameosagenta/iameosagenta.wast iameosagenta/iameosagenta.cpp
